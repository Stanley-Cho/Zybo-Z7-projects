...
-- Date        : Wed May 11 05:07:00 2022
-- Host        : SC_PC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/Stanc/Documents/Final_proj/hardware/img_pro/img_pro.gen/sources_1/bd/design_1/ip/design_1_axi_dynclk_0_0/design_1_axi_dynclk_0_0_sim_netlist.vhdl
...
entity design_1_axi_dynclk_0_0_SyncAsync is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_axi_dynclk_0_0_axi_dynclk_S00_AXI is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_axi_dynclk_0_0_mmcme2_drp is
  port (
    I : out STD_LOGIC;
    ...
    \FSM_onehot_clk_state_reg[0]\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    \rom_do_reg[15]_0\ : in STD_LOGIC;
    \rom_do_reg[15]_1\ : in STD_LOGIC;
    \rom_do_reg[15]_2\ : in STD_LOGIC_VECTOR ( 6 downto 0 );
...
architecture STRUCTURE of design_1_axi_dynclk_0_0_mmcme2_drp is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of DEN_i_1 : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \rom_addr[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rom_do[13]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \rom_do[14]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \rom_do[15]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rom_do[23]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rom_do[25]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rom_do[27]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rom_do[28]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \rom_do[31]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rom_do[32]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rom_do[33]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rom_do[34]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rom_do[36]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rom_do[38]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \state_count[0]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state_count[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \state_count[2]_i_1\ : label is "soft_lutpair3";
begin
  mmcm_adv_inst_0 <= \^mmcm_adv_inst_0\;
...
\FSM_onehot_clk_state[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => Q(2),
      I3 => Q(4),
      I4 => \FSM_onehot_clk_state_reg[0]\(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_axi_dynclk_0_0_axi_dynclk is
  port (
    REF_CLK_I : in STD_LOGIC;
  ...
  attribute kRefClkFreqHz of design_1_axi_dynclk_0_0_axi_dynclk : entity is 100000000;
  attribute kVersionMajor : integer;
  attribute kVersionMajor of design_1_axi_dynclk_0_0_axi_dynclk : entity is 1;
  attribute kVersionMinor : integer;
  attribute kVersionMinor of design_1_axi_dynclk_0_0_axi_dynclk : entity is 2;
...
Inst_mmcme2_drp: entity work.design_1_axi_dynclk_0_0_mmcme2_drp
     port map (
      D(11 downto 10) => rom(12 downto 11),
      D(9 downto 0) => rom(9 downto 0),
      E(0) => Inst_mmcme2_drp_n_6,
      \FSM_onehot_clk_state_reg[0]\(0) => CTRL_REG,
      I => I,
      Q(4) => STAT_REG(0),
      ...
      \rom_do_reg[15]_2\(6) => data1(15),
      \rom_do_reg[15]_2\(5) => data0(15),
      \rom_do_reg[15]_2\(4 downto 3) => data2(14 downto 13),
      \rom_do_reg[15]_2\(2) => data2(10),
      \rom_do_reg[15]_2\(1 downto 0) => data3(14 downto 13),
      s_axi_lite_aclk => s_axi_lite_aclk,
      sen_reg => sen_reg
    );
SyncAsyncLocked: entity work.design_1_axi_dynclk_0_0_SyncAsync
     port map (
      LOCKED_O => \^locked_o\,
      RST => RST,
...
axi_dynclk_S00_AXI_inst: entity work.design_1_axi_dynclk_0_0_axi_dynclk_S00_AXI
     port map (
      D(11 downto 10) => rom(12 downto 11),
      D(9 downto 0) => rom(9 downto 0),
      Q(0) => CTRL_REG,
      ...
      \axi_rdata_reg[0]_0\(1) => STAT_REG(0),
      \axi_rdata_reg[0]_0\(0) => \FSM_onehot_clk_state_reg_n_0_[2]\,
...
entity design_1_axi_dynclk_0_0 is
  ...
  attribute NotValidForBitStream of design_1_axi_dynclk_0_0 : entity is true;
  ...
  attribute x_core_info of design_1_axi_dynclk_0_0 : entity is "axi_dynclk,Vivado 2021.2.1";
...
architecture STRUCTURE of design_1_axi_dynclk_0_0 is
  ...
  attribute x_interface_parameter of REF_CLK_I : signal is "XIL_INTERFACENAME REF_CLK_I, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK1, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of s_axi_lite_aclk : signal is "XIL_INTERFACENAME S_AXI_LITE_CLK, ASSOCIATED_BUSIF S_AXI_LITE, ASSOCIATED_RESET s_axi_lite_aresetn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, INSERT_VIP 0, XIL_INTERFACENAME s_axi_lite_aclk, ASSOCIATED_RESET s_axi_lite_aresetn, FREQ_HZ 200000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF S_AXI_LITE, INSERT_VIP 0";
...
U0: entity work.design_1_axi_dynclk_0_0_axi_dynclk
     port map (
      LOCKED_O => LOCKED_O,
